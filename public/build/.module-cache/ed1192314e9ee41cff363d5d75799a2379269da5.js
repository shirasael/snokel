...
var ConfigPage = React.createClass({displayName: "ConfigPage",
	...
	render: function() {
		...
		var buttons = [
			React.createElement("li", null, React.createElement("a", {onClick: this.showJSON}, React.createElement("i", {className: "mdi-action-search left"}), "Show JSON")),
      React.createElement("li", null, React.createElement("a", {onClick: this.handleSave}, React.createElement("i", {className: "mdi-file-file-upload left"}), "SAVE"))
		];
		return (
