var ConfigForm = React.createClass({displayName: "ConfigForm",
  getInitialState: function() {
	...
	render: function() {
		var costume = React.createElement(JsonEditor, {data: this.state.data, onChange: this.updateData, ref: "costume"});
		var raw = React.createElement(RawEditor, {data: this.state.data, onChange: this.updateData, ref: "raw"})
		return (
