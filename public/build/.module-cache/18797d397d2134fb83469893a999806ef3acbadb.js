...
var TypeSelector = React.createClass({displayName: "TypeSelector",
  ...
  componentDidMount: function() {
	...
	render: function() {
		return (
			React.createElement("div", {className: "typeSelectorDiv"}, 
				React.createElement("select", {className: "typeSelector", ref: "selector", value: this.state.selected, onChange: this.handleChange}, 
...
var ConfigComponentCreator = React.createClass({displayName: "ConfigComponentCreator",
	genenrateComponent: function() {
		var fieldType = this.refs.compType.refs.selector.selected;
		if (fieldType != "") {
