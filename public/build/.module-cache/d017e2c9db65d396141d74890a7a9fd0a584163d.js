...
var ListInput = React.createClass({displayName: "ListInput",
	...
	renderInnerComponents: function() {
		...
		for (var index = 0; index < this.state.value.length; index++) {
			...
			comps.push(
				React.createElement("li", {className: "collection-item", key: index}, 
					comp
				)
			);
		}
		...
		return (
			React.createElement("div", {className: "listCompsDiv listInput"}, 
				React.createElement("div", {className: "row existingList"}, 
					React.createElement("ol", {className: "collection"}, 
...
var DictInput = React.createClass({displayName: "DictInput",
  ...
  renderInnerComponents: function() {
  	...
  	for (compName in this.state.value) {
  		...
  		comps.push(
  			React.createElement("li", {className: "collection-item", key: index}, 
  				React.createElement(ConfigComponent, {onChange: this.handleChange, fieldName: compName, value: val, dataMeta: meta})
  			))
  		index++;
  	}
  	return comps;
...
var ConfigComponent = React.createClass({displayName: "ConfigComponent",
  ...
  render: function() {
    ...
    return (
    	React.createElement("div", {className: "configComp row", onMouseLeave: this.onMouseLeave, onMouseOver: this.onMouseOver}, 
    		React.createElement("div", {className: "col s1"}, 
    			React.createElement("a", {className: "btn-floating btn-small waves-effect waves-light red", onClick: this.props.onRemove}, React.createElement("i", {className: "mdi-content-remove"}))
    		), 
    		React.createElement("div", {className: "col s11"}, 
	      	React.createElement("span", {style: nameStyle, className: "propName"}, this.props.fieldName), 
