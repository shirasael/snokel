...
var BoolInput = React.createClass({displayName: "BoolInput",
	defaultValue: false,
	getInitialState: function() {
		return {value: (this.props.value == null ? this.defaultValue : this.props.value), dataMeta: this.props.dataMeta};
	},
	handleChange: function(event) {
...
var ListInput = React.createClass({displayName: "ListInput",
	...
	addComponent: function(compType) {
		...
		this.state.value.push(InputHelper.getDefalutValue(compType));
		this.setState({value: this.state.value, dataMeta: this.state.dataMeta});
		this.props.valueChanged(this, {value: this.state.value, dataMeta: this.state.dataMeta});
	},
	render: function() {
...
var InputHelper = {
	...
	getDefalutValue: function(elmType) {
		var inElm = this.generateInputElement(null, null, {self: elmType}, null);
		if (inElm != null) {
			return inElm.defaultValue;
		}
		return null;
	}
};
