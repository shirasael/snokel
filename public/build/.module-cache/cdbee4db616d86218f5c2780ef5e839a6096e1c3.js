	...
	render: function() {
		return (
		    ...
		    React.createElement("div", {className: this.getClassName()}, 
		      React.createElement(SystemFront, {color: colors[0], sysName: this.props.sysName, imgSrc: this.props.sysImg}), 
		      React.createElement(SystemBack, {color: colors[1], configs: this.props.configs, sysName: this.props.sysName})
		    )
		  )
		);
	}
