      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "col s4"}, 
          React.createElement("ul", {className: "tabs"}, 
            React.createElement("li", {className: "tab col s2"}, React.createElement("a", {className: "active", href: "#editor"}, "Costume Editor")), 
            React.createElement("li", {className: "tab col s2"}, React.createElement("a", {href: "#raw"}, "Raw Editor"))
          )
        ), 
        React.createElement("br", null), 
        React.createElement("br", null), 
        React.createElement("div", {id: "editor", className: "col s12"}, this.props.costume), 
