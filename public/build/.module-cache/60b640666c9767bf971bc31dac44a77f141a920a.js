	...
	render: function() {
		return (
        	...
        	React.createElement(TypeSelector, {ref: "compType"})
				...
				React.createElement("div", {className: "col s2"}, 
				  React.createElement("a", {className: "btn-floating btn-small waves-effect waves-light red", onClick: this.genenrateComponent}, React.createElement("i", {className: "mdi-content-remove"}))
				)
			)
		);
	}
