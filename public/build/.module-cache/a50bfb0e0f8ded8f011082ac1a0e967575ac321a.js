...
var ConfigPage = React.createClass({displayName: "ConfigPage",
  ...
  componentDidMount: function() {
	...
	render: function() {
		...
		console.log(meta);
		return (
		  React.createElement(Layout, {navBackArrow: true, navBackRef: "/"}, 
				React.createElement("div", null, 
					...
					React.createElement(MaterialButton, {lable: "SAVE!", onClick: this.handleSave, icon: "mdi-file-cloud", right: true}), 
