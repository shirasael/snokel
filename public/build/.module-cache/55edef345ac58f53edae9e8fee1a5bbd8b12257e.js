...
var SystemBack = React.createClass({displayName: "SystemBack",
	renderServers: function() {
		return this.props.servers.map(function(server, index) {
			sysUrl = "/system/" + this.props.sysName + "/" + server;
			return (
				React.createElement("a", {className: "server", key: index, href: sysUrl}, server)
			);
		});
	},
	render: function() {
	...
	render: function() {
		return (
		    ...
		    React.createElement("div", {className: this.getClassName()}, 
		      ...
		      React.createElement(SystemBack, {color: "red", servers: this.props.servers, sysName: this.props.sysName})
		    )
		  )
		);
	}
...
var SystemsList = React.createClass({displayName: "SystemsList",
	...
	renderSystems: function() {
		return this.state.systems.map(function (sys, index) {
			return (
				React.createElement(SystemCard, {sysName: sys.name, key: index, servers: sys.servers})
			);
		});
	},
	render: function() {
