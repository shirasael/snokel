...
var TypeSelector = React.createClass({displayName: "TypeSelector",
	getInitialState: function() {
		return {selectorId: (Math.floor(Math.random() * 10000000000)).toString(36)};
	},
...
var JsonEditor = React.createClass({displayName: "JsonEditor",
	...
	onDataChanged: function(obj, state) {
		...
		this.props.onChange({data: state.value, dataMeta: state.dataMeta});
	},
	...
	render: function() {
		return (
			React.createElement(DictInput, {value: this.state.data, dataMeta: this.state.dataMeta, valueChanged: this.onDataChanged})
		);
	}
});
...
var RawEditor = React.createClass({displayName: "RawEditor",
	...
	render: function() {
        ...
        React.createElement("div", {className: "input-field col s12"}, 
          ...
          React.createElement("label", {for: "icon_prefix2"}, "First Name")
        )
		  )
		);
	}
