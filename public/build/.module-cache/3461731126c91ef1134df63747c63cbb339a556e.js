var ConfigComponent = React.createClass({displayName: "ConfigComponent",
	getInputElement: function(ref) {
		...
		if (elmType == "num") {
			return ( React.createElement(NumberInput, {ref: ref, value: val, onValueChanged: this.props.onChange}) );
		} else if (elmType == "str") {
			return ( React.createElement(StringInput, {ref: ref, value: val, onValueChanged: this.props.onChange}) );
		} else if (elmType == "bool") {
			return ( React.createElement(BoolInput, {ref: ref, value: val, onValueChanged: this.props.onChange}) );
		} else {
			return null;
		}
	},
