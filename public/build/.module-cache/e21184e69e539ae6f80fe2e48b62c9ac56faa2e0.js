...
var TypeSelector = React.createClass({displayName: "TypeSelector",
  ...
  componentDidMount: function() {
	...
	render: function() {
		  ...
		  // </div>
		return (
				React.createElement("select", {className: "typeSelector", value: this.state.selected, onChange: this.handleChange}, 
					React.createElement("option", {value: "", disabled: true, selected: true, onChange: this.handleChange}, "Comp. Type"), 
...
var ConfigComponentCreator = React.createClass({displayName: "ConfigComponentCreator",
	genenrateComponent: function() {
		var fieldType = this.refs.compType.selected;
		if (fieldType != "") {
