        	...
        	React.createElement("div", {className: "col s4"}, 
		          React.createElement("div", {className: "card"}, 
		            ...
		            React.createElement("div", {className: "card-content"}, 
		              React.createElement("span", {className: "card-title activator grey-text text-darken-4"}, "Card Title ", React.createElement("i", {className: "mdi-navigation-more-vert right"})), 

		              React.createElement("p", null, React.createElement("a", {href: "#!"}, "This is a link"))
		            ), 
		            React.createElement("div", {className: "card-reveal"}, 
		              React.createElement("span", {className: "card-title grey-text text-darken-4"}, "Card Title ", React.createElement("i", {className: "mdi-navigation-close right"})), 
