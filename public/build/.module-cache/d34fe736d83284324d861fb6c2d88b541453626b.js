		...
		return (
		  React.createElement(Layout, {navBackArrow: true, navBackRef: "/", navbarButtons: buttons}, 
				React.createElement("div", null, 
					...
					React.createElement(ConfigForm, {ref: "confForm", data: this.state.confs, dataMeta: meta, onChange: this.handleChange})
				)
			)
		);
	}
