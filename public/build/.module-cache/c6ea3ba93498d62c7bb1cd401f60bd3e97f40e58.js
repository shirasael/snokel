...
var StringInput = React.createClass({displayName: "StringInput",
	getInitialState: function() {
		return {value: this.props.value, dataMeta: this.props.dataMeta, isNull: false};
	},
	handleChange: function(event) {
  ...
  setNull: function(event) {
	...
	render: function() {
		return (
	      ...
	      React.createElement("input", {type: "checkbox", checked: this.state.isNull, onChange: this.setNull, className: "nully"})
	    )
		);
