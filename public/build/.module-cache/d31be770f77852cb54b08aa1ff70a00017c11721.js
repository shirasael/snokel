...
var RaisedButton = require('../static/material-ui/raised-button');
var Theme = require('../static/material-ui/styles/themes/dark-theme.js');
	...
	render: function() {
		return (
			React.createElement("div", null, 
				...
				React.createElement(RaisedButton, {label: "YO", onMouseDown: this.doSomething})
			)
		);
...
React.withContext({'muiTheme': Theme}, function () {
	React.render(
