...
var ConfigComponentCreator = React.createClass({displayName: "ConfigComponentCreator",
	...
	render: function() {
		return (
			React.createElement("form", {className: "componentCreator", onSubmit: this.genenrateComponent}, 
        React.createElement("input", {type: "text", placeholder: "Name", ref: "compName"}), 
        React.createElement("span", null, " : "), 
        React.createElement(TypeSelector, {ref: "compType"}), 
				React.createElement("input", {type: "submit", value: "Generate Component"})
			)
		);
	}
});
...
var ConfigComponentsList = React.createClass({displayName: "ConfigComponentsList",
  renderComponents: function() {
  	...
  	return this.props.data.map(function (compData) {
  		return React.createElement(ConfigComponent, {fieldName: compData.fieldName, fieldType: compData.fieldType, fieldValue: compData.fieldValue})
  	});
  },
  addComponent: function(compName, compType) {
  	this.props.data.push({fieldName: compName, fieldType: compType, fieldValue: null});
  	console.log(this.props.data);
  },
	render: function() {
		return (
...
var ConfigForm = React.createClass({displayName: "ConfigForm",
	...
	render: function() {
		return (
			React.createElement("form", {className: "configForm", onSubmit: this.handleSubmit}, 
