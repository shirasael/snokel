		...
		return (
			React.createElement("div", null, 
				...
				React.createElement("div", {className: "configForm"}, 
					React.createElement(ConfigComponentsList, {ref: "configComponents", data: this.linkState('data'), dataMeta: this.linkState('dataMeta')})
				)
			)
		);
	}
	...
	render: function() {
		return (
			React.createElement("div", null, 
				...
				React.createElement(ConfigForm, {ref: "confForm"}), 
