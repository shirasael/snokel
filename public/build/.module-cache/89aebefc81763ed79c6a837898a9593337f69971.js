...
var RawEditor = React.createClass({displayName: "RawEditor",
	...
	render: function() {
        ...
        React.createElement("div", {className: "input-field col s12"}, 
          React.createElement("textarea", {id: "icon_prefix2", className: "materialize-textarea rawInput", value: this.state.data, onChange: this.handleChange}), 
          React.createElement("label", {for: "icon_prefix2"}, "Raw Data", React.createElement("br", null))
        )
		  )
		);
	}
