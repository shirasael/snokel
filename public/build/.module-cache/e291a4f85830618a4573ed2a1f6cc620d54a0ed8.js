var ConfigComponent = React.createClass({displayName: "ConfigComponent",
  ...
  render: function() {
  	var inputElem = getInputElement(this.props.fieldType, "input", this.props.fieldValue);
    return (
...
var NumberInput = React.createClass({displayName: "NumberInput",
	...
	render: function() {
		return (
			React.createElement("input", {type: "number", value: this.props.value, onChange: this.handleChange})
		);
	}
});
...
var BoolInput = React.createClass({displayName: "BoolInput",
	render: function() {
		return (
			React.createElement("input", {type: "checkbox", checked: this.props.value, onChange: this.handleChange})
		);
	}
});
