	...
	render: function() {
		return (
		    ...
		    React.createElement("div", {className: this.getClassName()}, 
		      React.createElement(SystemFront, {color: "black", sysName: this.props.sysName, imgSrc: this.props.sysImg}), 
		      React.createElement(SystemBack, {color: "green", configs: this.props.configs, sysName: this.props.sysName})
		    )
		  )
		);
	}
