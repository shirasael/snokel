var SystemCard = React.createClass({displayName: "SystemCard",
    render: function () {
        ...
        var confs = this.props.configs.map(function (cfg, index) {
            return (
                React.createElement("li", {className: "collection-item", key: index}, React.createElement("div", null, cfg, React.createElement("a", {href: sysUrl + "/" + cfg, className: "secondary-content"}, React.createElement("i", {className: "mdi-action-settings"}))))
            );
        });
        return (
        	React.createElement("div", {className: "col s4"}, 
	          React.createElement("div", {className: "card small"}, 
	            ...
	            React.createElement("div", {className: "card-content"}, 
	              React.createElement("span", {className: "card-title activator grey-text text-darken-4"}, this.props.sysName, 
	              	React.createElement("i", {className: "mdi-arrow-back right"})
	              )
	            ), 
