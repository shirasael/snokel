      ...
      React.createElement("div", {className: "row"}, 
        React.createElement("div", {className: "col s12"}, 
          React.createElement("ul", {className: "tabs"}, 
            React.createElement("li", {className: "tab col s3"}, React.createElement("a", {href: "#test1"}, "Test 1")), 
            React.createElement("li", {className: "tab col s3"}, React.createElement("a", {className: "active", href: "#test2"}, "Test 2")), 
            React.createElement("li", {className: "tab col s3"}, React.createElement("a", {href: "#test3"}, "Test 3")), 
            React.createElement("li", {className: "tab col s3"}, React.createElement("a", {href: "#test4"}, "Test 4"))
          )
        ), 
        React.createElement("div", {id: "test1", className: "col s12"}, "Test 1"), 
        React.createElement("div", {id: "test2", className: "col s12"}, "Test 2"), 
        React.createElement("div", {id: "test3", className: "col s12"}, "Test 3"), 
        React.createElement("div", {id: "test4", className: "col s12"}, "Test 4")
      )
    );
  }
});
