...
var StringInput = React.createClass({displayName: "StringInput",
  ...
  setNull: function() {
  	console.log("HERE!!");
  	this.state.isNull = this.refs.nullbox.checked;
	...
	render: function() {
		return (
	    	...
	    	React.createElement("p", {onClick: this.setNull}, 
		      React.createElement("input", {ref: "nullbox", type: "checkbox", id: "nullbox", checked: this.state.isNull, onChange: this.setNull}), 
