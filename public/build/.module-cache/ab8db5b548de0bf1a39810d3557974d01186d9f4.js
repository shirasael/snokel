...
var NumberInput = React.createClass({displayName: "NumberInput",
    ...
    this.setState({value : newVal, dataMeta: this.state.dataMeta}, this.props.valueChanged(newVal, this.state.dataMeta));
  },
	render: function() {
		return (
...
var StringInput = React.createClass({displayName: "StringInput",
    ...
    this.props.valueChanged(newVal, this.state.dataMeta);
  },
	render: function() {
		return (
...
var ConfigComponent = React.createClass({displayName: "ConfigComponent",
	...
	handleChange: function(newVal, newMeta) {
		console.log(this.state);
		this.setState({value: newVal, dataMeta: newMeta}, this.props.onChange(this));
		console.log(this.state);
	},
  render: function() {
