...
var ConfigComponentsList = React.createClass({displayName: "ConfigComponentsList",
  ...
  renderComponents: function() {
  	var comps = []
  	for (comp in this.state.data) {
  		comps.push(React.createElement(ConfigComponent, {key: index, onChange: this.handleValChange, fieldName: compData.fieldName, fieldType: compData.fieldType, value: compData.fieldValue}))
  	}
  	return comps;
  },
