...
var StringInput = React.createClass({displayName: "StringInput",
	...
	render: function() {
		return (
	      ...
	      React.createElement("input", {value: this.state.value, id: "first_name2", type: "text", onChange: this.handleChange}), 
	      React.createElement("label", {className: "active", for: "first_name2"}, "First Name")
	    )
		);
