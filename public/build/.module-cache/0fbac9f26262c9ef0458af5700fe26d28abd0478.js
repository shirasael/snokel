    ...
    return (
    	React.createElement("div", {className: "configComp row", onMouseLeave: this.onMouseLeave, onMouseOver: this.onMouseOver}, 
    		React.createElement("div", {className: "col s1"}, 
    			React.createElement("a", {className: "btn-floating btn-small btn-flat waves-effect waves-light red", onClick: this.props.onRemove}, React.createElement("i", {className: "mdi-content-remove"}))
    		), 
