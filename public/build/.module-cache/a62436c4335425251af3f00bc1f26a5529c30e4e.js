var NullableInput = React.createClass({displayName: "NullableInput",
	getInitialState: function() {
		return {value: this.props.value, lastVal: this.props.value, isNull: this.props.value == null};
	},
  ...
  setNull: function() {
  	...
  	this.setState(this.state);
    this.props.onNullEvent(this);
  },
	render: function() {
		return (
			React.createElement("div", {className: "nullableInput row"}, 
...
var NumberInput = React.createClass({displayName: "NumberInput",
    ...
    this.refs.nullable.updateValue(this.state.value);
    this.props.valueChanged(this);
  },
  handleNullEvent: function(nullable) {
		this.state.value = nullable.state.value;
    this.setState({value : this.state.value, dataMeta: this.state.dataMeta});
    this.props.valueChanged(this);
  },
	render: function() {
		return (
			React.createElement(NullableInput, {ref: "nullable", value: this.state.value, onNullEvent: this.handleNullEvent}, 
				React.createElement("div", {className: "input-field numInput"}, 
					React.createElement("input", {disabled: this.refs.nullable.isNull, type: "number", value: this.state.value, onChange: this.handleChange})
				)
			)
		);
	}
...
var StringInput = React.createClass({displayName: "StringInput",
	getInitialState: function() {
		return {value: this.props.value, lastVal: this.props.value, dataMeta: this.props.dataMeta, isNull: false};
	},
	handleChange: function(event) {
