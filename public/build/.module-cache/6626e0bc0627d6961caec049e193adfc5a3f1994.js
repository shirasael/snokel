...
var ConfigComponent = React.createClass({displayName: "ConfigComponent",
  ...
  render: function() {
    ...
    return (
    	React.createElement("div", {className: "row configComp", onMouseLeave: this.onMouseLeave, onMouseOver: this.onMouseOver}, 
	      React.createElement("div", {className: "col s9"}, 
	      	React.createElement("section", null, React.createElement("span", {style: nameStyle}, this.props.fieldName, " :"), inputElem)
	      ), 
	      React.createElement("div", {className: "col s1"}, 
	      	React.createElement(MaterialButton, {onClick: this.props.onRemove}, "Remove")
	      )
      )
    );
  }
