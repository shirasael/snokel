...
var ConfigComponentsList = React.createClass({displayName: "ConfigComponentsList",
  ...
  renderComponents: function() {
  	...
  	for (compName in this.state.data) {
  		comps.push(React.createElement(ConfigComponent, {key: index, onChange: this.handleValChange, fieldName: compName, fieldType: compData.fieldType, value: compData.fieldValue}))
  		index++;
  	}
  	return comps;
  },
