...
var StringInput = React.createClass({displayName: "StringInput",
  ...
  setNull: function() {
  	...
  	this.state.value = this.state.isNull ? null : this.refs.inbox.value;
  	this.setState(this.state);
    this.props.valueChanged(this);
  },
	render: function() {
		return (
	    	...
	    	React.createElement("input", {disabled: this.state.isNull, ref: "inbox", value: this.state.value, type: "text", onChange: this.handleChange}), 
